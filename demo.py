...
if __name__ == '__main__':
    ...
    path = r"E:\datasets\SecurityDatasets\Sleeping\images"        # 图片路径
    xml_path = r"E:\datasets\SecurityDatasets\Sleeping\Annotations"      # xml标注保存路径
    ...
    for name in os.listdir(path):
        ...
        img0, xyxy_list,img_crop= yolo.detect(image,conf_thres=0.25, iou_thres=0.45)
        print("xyxy_list",xyxy_list)
        # img0检测后的图像，img_crop裁剪的图像
